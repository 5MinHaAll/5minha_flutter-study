...
class MemberYunggunePage extends StatelessWidget {
  const MemberYunggunePage({super.key});
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Center(
              child: Hero(
                tag: 'assets/images/yunggune.png',
                child: Container(
                  width: 250,
                  height: 250,
                  decoration: BoxDecoration(
                    ...
                    image: const DecorationImage(
                      image: AssetImage('assets/images/yunggune.png'),
                      fit: BoxFit.cover,
                    ),
                    border: Border.all(
